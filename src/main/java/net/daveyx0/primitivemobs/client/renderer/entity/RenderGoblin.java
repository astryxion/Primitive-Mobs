...
public class RenderGoblin extends HumanoidMobRenderer<EntityGoblin, ModelGoblin<EntityGoblin>> {
   public static final ModelLayerLocation MODEL_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("primitivemobs", "goblin"), "main");
   private static final ResourceLocation GOBLIN_TEXTURES = ResourceLocation.fromNamespaceAndPath("primitivemobs", "textures/entity/goblin/goblin.png");
