...
public class LayerGroveSpriteStump extends RenderLayer<EntityGroveSprite, ModelGroveSprite> {
   private static final ResourceLocation GROVESTUMP_TEXTURES = ResourceLocation.fromNamespaceAndPath("primitivemobs", "textures/entity/grovesprite/grovestump.png");
