...
public class RenderBabySpider<T extends EntityBabySpider> extends MobRenderer<T, SpiderModel<T>> {
   private static final ResourceLocation BABY_SPIDER_TEXTURES = ResourceLocation.fromNamespaceAndPath("primitivemobs", "textures/entity/spiderfamily/babyspider.png");
   private static final ResourceLocation SPIDER_TEXTURES = ResourceLocation.fromNamespaceAndPath("primitivemobs", "textures/entity/spiderfamily/spider.png");
