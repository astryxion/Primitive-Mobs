...
public class RenderYeti extends MobRenderer<EntityYeti, ModelYeti> {
   public static final ModelLayerLocation MODEL_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("primitivemobs", "yeti"), "main");
   private static final ResourceLocation YETI_TEXTURES = ResourceLocation.fromNamespaceAndPath("primitivemobs", "textures/entity/yeti/yeti.png");
