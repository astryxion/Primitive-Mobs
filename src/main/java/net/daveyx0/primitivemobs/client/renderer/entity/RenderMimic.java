...
public class RenderMimic extends MobRenderer<EntityMimic, ModelMimic<EntityMimic>> {
   ...
   private static final ResourceLocation CHEST_TEXTURES = new ResourceLocation("primitivemobs", "textures/entity/mimic/vanilla_chest.png");
   private static final ResourceLocation CHEST_CHRISTMAS_TEXTURES = new ResourceLocation("primitivemobs", "textures/entity/mimic/vanilla_christmas.png");
