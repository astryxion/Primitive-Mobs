...
public class ModelBrainSlime<T extends Entity> extends EntityModel<T> {
    ...
    public ModelBrainSlime(ModelPart root, boolean hasEyes) {
    ...
    public static LayerDefinition createInnerBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("slime_bodies",
            CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 17.0F, -3.0F, 6.0F, 6.0F, 6.0F),
            PartPose.ZERO);
