...
public class PrimitiveMobsSpawnRegistry extends MMSpawnRegistry {
   public static void registerSpawns() {
      ...
      registerSpawnEntry((new MMConfigSpawnEntry("_Harpy", "primitivemobs:harpy", 100, true)).setHeightLevel(100, -1).setGroupSize(1, 3).setOverrideCanSpawnHere(true).setSpawnBlocks(new String[]{"minecraft:grass_block", "minecraft:stone", "minecraft:dirt", "minecraft:snow_block"}));
