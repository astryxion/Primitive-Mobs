...
public class PrimitiveMobsEntityRegistry extends MMEntityRegistry {
   ...
   public static final RegistryObject<EntityType<EntityChameleon>> CHAMELEON = ENTITY_TYPES.register("chameleon",
      () -> EntityType.Builder.of(EntityChameleon::new, MobCategory.CREATURE).sized(0.6F, 0.5F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:chameleon"));

   public static final RegistryObject<EntityType<EntityTreasureSlime>> TREASURE_SLIME = ENTITY_TYPES.register("treasure_slime",
      () -> EntityType.Builder.of(EntityTreasureSlime::new, MobCategory.MONSTER).sized(2.04F, 2.04F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:treasure_slime"));

   public static final RegistryObject<EntityType<EntityHauntedTool>> HAUNTED_TOOL = ENTITY_TYPES.register("haunted_tool",
      () -> EntityType.Builder.of(EntityHauntedTool::new, MobCategory.MONSTER).sized(0.6F, 1.8F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:haunted_tool"));

   public static final RegistryObject<EntityType<EntityGroveSprite>> GROVESPRITE = ENTITY_TYPES.register("grovesprite",
      () -> EntityType.Builder.of(EntityGroveSprite::new, MobCategory.CREATURE).sized(0.6F, 1.2F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:grovesprite"));

   public static final RegistryObject<EntityType<EntityEnchantedBook>> BEWITCHED_TOME = ENTITY_TYPES.register("bewitched_tome",
      () -> EntityType.Builder.of(EntityEnchantedBook::new, MobCategory.MONSTER).sized(0.6F, 0.8F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:bewitched_tome"));

   public static final RegistryObject<EntityType<EntityFilchLizard>> FILCH_LIZARD = ENTITY_TYPES.register("filch_lizard",
      () -> EntityType.Builder.of(EntityFilchLizard::new, MobCategory.CREATURE).sized(0.6F, 0.7F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:filch_lizard"));

   public static final RegistryObject<EntityType<EntityBrainSlime>> BRAIN_SLIME = ENTITY_TYPES.register("brain_slime",
      () -> EntityType.Builder.of(EntityBrainSlime::new, MobCategory.MONSTER).sized(2.04F, 2.04F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:brain_slime"));

   public static final RegistryObject<EntityType<EntityRocketCreeper>> ROCKET_CREEPER = ENTITY_TYPES.register("rocket_creeper",
      () -> EntityType.Builder.of(EntityRocketCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:rocket_creeper"));

   public static final RegistryObject<EntityType<EntityFestiveCreeper>> FESTIVE_CREEPER = ENTITY_TYPES.register("festive_creeper",
      () -> EntityType.Builder.of(EntityFestiveCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:festive_creeper"));

   public static final RegistryObject<EntityType<EntitySupportCreeper>> SUPPORT_CREEPER = ENTITY_TYPES.register("support_creeper",
      () -> EntityType.Builder.of(EntitySupportCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:support_creeper"));
   ...
   public static final RegistryObject<EntityType<EntitySkeletonWarrior>> SKELETON_WARRIOR = ENTITY_TYPES.register("skeleton_warrior",
      () -> EntityType.Builder.of(EntitySkeletonWarrior::new, MobCategory.MONSTER).sized(0.6F, 1.99F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:skeleton_warrior"));
   ...
   public static final RegistryObject<EntityType<EntityBabySpider>> BABY_SPIDER = ENTITY_TYPES.register("baby_spider",
      () -> EntityType.Builder.of(EntityBabySpider::new, MobCategory.MONSTER).sized(0.7F, 0.5F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:baby_spider"));
   ...
   public static final RegistryObject<EntityType<EntityTravelingMerchant>> TRAVELING_MERCHANT = ENTITY_TYPES.register("traveling_merchant",
      () -> EntityType.Builder.of(EntityTravelingMerchant::new, MobCategory.CREATURE).sized(0.6F, 1.95F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:traveling_merchant"));

   public static final RegistryObject<EntityType<EntityDodo>> DODO = ENTITY_TYPES.register("dodo",
      () -> EntityType.Builder.of(EntityDodo::new, MobCategory.CREATURE).sized(0.7F, 0.9F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:dodo"));

   public static final RegistryObject<EntityType<EntityMimic>> MIMIC = ENTITY_TYPES.register("mimic",
      () -> EntityType.Builder.of(EntityMimic::new, MobCategory.MONSTER).sized(0.9F, 0.9F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:mimic"));

   public static final RegistryObject<EntityType<EntitySheepman>> SHEEPMAN = ENTITY_TYPES.register("sheepman",
      () -> EntityType.Builder.of(EntitySheepman::new, MobCategory.CREATURE).sized(0.6F, 1.95F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:sheepman"));

   public static final RegistryObject<EntityType<EntityGoblin>> GOBLIN = ENTITY_TYPES.register("goblin",
      () -> EntityType.Builder.of(EntityGoblin::new, MobCategory.MONSTER).sized(0.6F, 1.4F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:goblin"));

   public static final RegistryObject<EntityType<EntityHarpy>> HARPY = ENTITY_TYPES.register("harpy",
      () -> EntityType.Builder.of(EntityHarpy::new, MobCategory.MONSTER).sized(0.6F, 1.8F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:harpy"));

   public static final RegistryObject<EntityType<EntityFlameSpewer>> FLAME_SPEWER = ENTITY_TYPES.register("flame_spewer",
      () -> EntityType.Builder.of(EntityFlameSpewer::new, MobCategory.MONSTER).sized(1.0F, 1.8F).fireImmune().clientTrackingRange(8).updateInterval(3).build("primitivemobs:flame_spewer"));

   public static final RegistryObject<EntityType<EntityVoidEye>> VOID_EYE = ENTITY_TYPES.register("void_eye",
      () -> EntityType.Builder.of(EntityVoidEye::new, MobCategory.MONSTER).sized(0.8F, 0.8F).clientTrackingRange(8).updateInterval(3).build("primitivemobs:void_eye"));
